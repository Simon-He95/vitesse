    ...
    if (
      ...
      (e2 = (function (n3, t3) {
        if (n3) {
          ...
          return (
            'Object' === e3 && n3.constructor && (e3 = n3.constructor.name),
            'Map' === e3 || 'Set' === e3
              ? Array.from(n3)
              : 'Arguments' === e3 ||
    ...
    return (
      ...
      (e3.ln = function (n3) {
        var t3 = e3.fn,
          ...
          i2 = r3.state,
          o2 = r3 === e3.vn,
          a2 = { sw: r3, isExternal: o2, originalEvent: n3 }
        !o2 && e3.mn && (a2.isUpdate = true),
          e3.dispatchEvent(new u(i2, a2)),
          'installed' === i2
            ? (e3.wn = self.setTimeout(function () {
                'installed' === i2 &&
                  t3.waiting === r3 &&
    ...
    (w.bn = function () {
      try {
        ...
        return (function (n3, t2) {
          ...
          function () {
            return a(
              navigator.serviceWorker.register(n2.sn, n2.nn),
              function (t2) {
